...
dir_setup=False
input("Press enter to start test of mic alignment")
...
if test == True:
        ...
        test_data_file= "Results/test20190401/reflectionCAPTIFwall_1.txt"
...
temp = input("What's the current temperature (deg C): ")
c = 331 + 0.6* float(temp)
print("Speed of sound: {}m/s".format(c))
alignment_diff = {}
alignment_diff['mic2_1'] = time_shift['mic2'] - time_shift['mic1']
alignment_diff['mic2_3'] = time_shift['mic2'] - time_shift['mic3']
peak_diff ={}
peak_diff['mic2_1'] = (np.argmax(avgIR['mic2']) - np.argmax(avgIR['mic1']))/SR
peak_diff['mic2_3'] = (np.argmax(avgIR['mic2']) - np.argmax(avgIR['mic3']))/SR
dist_diff = {}
dist_diff['mic2_1'] = c*(peak_diff['mic2_1']+alignment_diff['mic2_1'])
dist_diff['mic2_3'] = c*(peak_diff['mic2_3']+alignment_diff['mic2_3'])


print("IR shift mic 2 to mic 1: {}".format(alignment_diff['mic2_1']))
print("IR shift mic 2 to mic 3: {}".format(alignment_diff['mic2_3']))
print("Time between peaks mic 2 to mic 1: {}".format(peak_diff['mic2_1']))
print("Time between peaks mic 2 to mic 3: {}".format(peak_diff['mic2_3']))
print("Total between mic 2 to mic 1: {}".format(peak_diff['mic2_1']+alignment_diff['mic2_1']))
print("Total between  mic 2 to mic 3: {}".format(peak_diff['mic2_3']+alignment_diff['mic2_3']))
print("dist shift mic 2 to mic 1: {}".format(dist_diff['mic2_1']))
print("dist shift mic 2 to mic 3: {}".format(dist_diff['mic2_3']))
...
output_file(os.path.join("BokehPlots/ImpulseResponse.html"))
